        ...
        <section className="my-work-section" id="myWork">
          ...
          <h3 className='section-title'>My Work</h3>
            ...
            <div className='content'>
              ...
              <div className='links'>
                <a className="link" href="https://github.com/wjacobs71086/Bug-Out-Ready-Client" target="newtab">GitHub Repo</a>
          ...
          <div className='piece'>
              <img className="project-image bookmark" src={bookmarkIcon} alt="BugOutReadyApp banner" />
            <div className='content'>
              ...
              <div className='links'>
                <a className="link" href="https://github.com/thinkful-ei-heron/BookMark-App" target="newtab">GitHub Repo</a>
          ...
          <div className='piece bottom'>
              <img className="project-image" src={PracticingImg} alt="BugOutReadyApp banner" />
            <div className='content'>
              ...
              <div className='links'>
                <a className="link" href="https://github.com/thinkful-ei-heron/spaced-repetition-client-heesu-wesley-zayar" target="newtab">GitHub Repo</a>
